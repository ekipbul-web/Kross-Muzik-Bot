...
try:
    print("🔄 Sunucuda FFmpeg kontrol ediliyor...")
    ffmpeg_downloader.ffdl()
...
# Komut ön eki K! olarak ayarlandı (case_insensitive=True ile k! veya K! kabul edilir)
...
@bot.command(name="play", help="Şarkı çalar. Kullanım: K!play şarkı_adı veya youtube_linki")
...
@bot.command(name="stop", help="Şarkıyı durdurur ve kanaldan çıkar. Kullanım: K!stop")
async def stop(ctx):
    voice_client = ctx.voice_client
